...
/**
 * Create a new ValueEntity with parameters
 ...
 * persisted.
 */
const response = entity.lookupType('view.HelloWorldResponse')
const state = entity.lookupType('view.HelloWorldState')
...
function sayHelloWorld(request, current, context) {
    ...
    // Update the state of the entity (which triggers an update to the View)
